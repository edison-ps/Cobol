      ***************************************************************
      *                                                             *
      *  A B A V / S P - I N F O R M A T I C A    :::  PGRC03       *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Relacao de CTAS a pagar :                                  *
      *                                                             *
      *  Data da ultima alteracao:    08/02/94     v1.00            *
      *                                                             *
      ***************************************************************
      * 
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGRC03".
      ...
      *
       rot-move-doc.
           move rc01-documento to doc-documento.
           move rc01-condicao to doc-condicao ab01-condicao.
           move rc01-codigo to doc-codigo ab01-codigo.
           if erro not = 0
              move "Nao cadastrado" to doc-razao
           else
              move ab01-razao-social-a to doc-razao
           end-if.
           move rc01-portador to doc-portador.
           move rc01-operacao to doc-operacao.
           ...
           move rc01-valor to doc-valor.
      *
       rot-move-cod.
           move rc01-documento to cod-documento.
           move rc01-condicao to cod-condicao ab01-condicao.
           move rc01-codigo to cod-codigo ab01-codigo.
           if erro not = 0
              move "Nao cadastrado" to cod-razao
           else
              move ab01-razao-social-a to cod-razao
           end-if.
           move rc01-portador to cod-portador.
           move rc01-operacao to cod-operacao.
           if rc01-vencimento not = 0
              move rc01-vencimento to dias-corr
              move 1 to opcao-data
              perform rot-data
           ...
           move rc01-valor to cod-valor.
      *
       rot-move-venc.
           move rc01-documento to venc-documento.
           move rc01-condicao to venc-condicao ab01-condicao.
           move rc01-codigo to venc-codigo ab01-codigo.
           if erro not = 0
              move "Nao cadastrado" to venc-razao
           else
              move ab01-razao-social-a to venc-razao
           end-if.
           move rc01-portador to venc-portador.
           move rc01-operacao to venc-operacao.
           if rc01-vencimento not = 0
              move rc01-vencimento to dias-corr
              move 1 to opcao-data
              perform rot-data
      ...
      *
       acc-situacao.
           accept sele-situacao at 1923 with auto update prompt
                  foreground-color 15 background-color 01.
           accept escape-key from escape.
      *
       acc-device.
      ...
      *
       dsp-situacao.
           display sele-situacao-disp at 1923 with foreground-color 15 
                   background-color 01.
      *
       dsp-device.
      ...
      *
       ...
       sec-cns-00.
           ...
           evaluate true
                    ...
                    when sele-ord = 2
                         move low-values to rc01-chave-1
                         move sele-codigo-i to rc01-codigo
                         move sele-condicao to rc01-condicao
                         start arqrc01 key is not less rc01-chave-1
                    when sele-ord = 3
                         move low-values to rc01-chave-2
                         move sele-venc-i to rc01-vencimento
                         start arqrc01 key is not less rc01-chave-2
           end-evaluate.
      *
       lab-cns-01.
           move 0 to erro.
           ...
           if rc01-codigo < sele-codigo-i or rc01-codigo > sele-codigo-f
              go to lab-cns-01
           end-if.
           if rc01-vencimento < sele-venc-i or 
              rc01-vencimento > sele-venc-f
              go to lab-cns-01
           end-if.
           if sele-condicao not = spaces
           ...
           evaluate true
                    when sele-ord = 2
                         if rc01-chave-1 not = chave-aux and
                            sub-total not = 0
                    ...
                    when sele-ord = 3
                         if rc01-vencimento not = data-ant and 
                            sub-total not = 0
                            move tracos-c to linha-detalhe
                            perform rot-print
           ...
           evaluate true
                    ...
                    when sele-ord = 2
                         ...
                         if ab01-razao-social-a not = razao-aux
                            ...
                            move rc01-chave-1 to chave-aux
                         end-if
                         move det-cod-02 to linha-detalhe
                         perform rot-print
                    when sele-ord = 3
                         perform rot-move-venc
                         if rc01-vencimento = data-ant 
                         ...
                         perform rot-print
                         move rc01-vencimento to data-ant
           end-evaluate.
           add rc01-valor to sub-total total.
           go to lab-cns-01.
      * 
       lab-cns-fim.
           if kbd2 not = 27
