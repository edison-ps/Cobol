      ***************************************************************
      *                                                             *
      *  E P S - S O F T                          :::  PGTAB06      *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Manutencao de Tabela Cotacoes de Moedas:                   *
      *                                                             *
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGTAB06".
      ...
      *
       01 campos.
          ...
          02 cotacao                   pic 9(04)v9(04) value 0.
          02 cotacao-aux               pic zzz9,9(04) value 0.              
      *
      ...
      *
       rot-move-tabl.
           move rotina-tipo to wtab07-tipo wtab07-tipo-1.
           move sigla to wtab07-sigla wtab07-sigla-1 rotina-sigla.
           move data-a to wtab07-data-1 wtab07-data in wtab07-chave.
           move spaces to wtab07-resto.
           move cotacao to wtab07-cotacao.
           move param-usr to wtab07-usr.
           move param-data to wtab07-data in wtab07-dados.
           move reg-wtab07 to reg-tabl.
      *
       rot-move-campos.
           move reg-tabl to reg-wtab07
           move wtab07-sigla to sigla rotina-sigla.
           move wtab07-data-1 to dias-corr.
           ...
           move wtab07-cotacao to cotacao cotacao-aux.
           move wtab07-usr to cab-usuario.
           move wtab07-data in wtab07-dados to dias-corr.
           move 1 to opcao-data.
           perform rot-data.
      ...
      *
       rot-display.
           ...
           perform dsp-sigla thru dsp-cotacao.
      ...
      *
       err-cotacao-c.
           move " Cotacao ja cadastrada - Tecle <Enter>" to mens-erro.
           perform display-tela-erro-cad.
           perform rot-keypress.
           perform display-tela-limpa-cad.
      *
      ...
      *
       display-tela-01.
           ...
           display "Data......:" at line linha column coluna with
                                    foreground-color 06
                                    background-color 01 highlight.
      ...
      *
       display-tela-03.
           ...
           display "D" at line linha column coluna with highlight
                          foreground-color 02 background-color 03.
           add 1 to coluna.
           display "ata" at line linha column coluna with
                                foreground-color 05 background-color 03.
      *
       display-tela-04.
           add rotina-lin to 7 giving linha.
      ...
      *
       acc-data-a.
           ...
           add rotina-col to 14 giving coluna.
           accept data-a at line linha column coluna with auto update 
                  prompt foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
       acc-cotacao.
           ...
           add rotina-col to 14 giving coluna.
           accept cotacao-aux at line linha column coluna with auto 
      ...
      *
       dsp-data-a.
           add rotina-lin to 4 giving linha.
           add rotina-col to 14 giving coluna.
           display data-a-disp at line linha column coluna with
                   foreground-color 15 background-color 01.
      *
       dsp-cotacao.
           add rotina-lin to 5 giving linha.
           add rotina-col to 14 giving coluna.
           display cotacao-aux at line linha column coluna with
                   foreground-color 15 background-color 01.
      *
      ...
      *
       lab-inc-02.
           ...
           perform dsp-data-a.
           move 11 to wtab07-tipo.
           move sigla to wtab07-sigla.
           move data-a to wtab07-data in wtab07-chave.
           move spaces to wtab06-resto.
           move reg-wtab07 to reg-tabl.
           perform rot-le-tabl.
           if erro = 0
              perform err-cotacao-c
              go to lab-inc-02
           end-if.
      *
       lab-inc-03.
           move 0 to cotacao-aux.
           perform lmp-cotacao.
           perform acc-cotacao.
           if escape-key = 1
              perform lmp-cotacao
      ...
      *
       lab-inc-04.
           ...
           if resposta = "N"
              perform lmp-sigla thru lmp-cotacao
              perform display-tela-02
              go to lab-inc-01
           else
              if resposta not = "S"
      ...
      *
       lab-cns-sigla-00.
           ...
           move low-values to wtab07-chave.
           move rotina-tipo to wtab07-tipo
           move txt to sigla wtab07-sigla.
           move spaces to wtab07-resto.
           move wtab07-chave to tabl-chave.
      *
       lab-cns-sigla-00-a.
      ...
      *
       lab-cns-sigla-01.
           ...
           move reg-tabl to reg-wtab07.
           if erro not = 0 or wtab07-sigla = sigla and wtab07-data-1 =
              data-a
              perform lmp-sigla thru lmp-cotacao
              start arqtabl key is not less tabl-chave
      ...
      *
       lab-cns-data-00.
           ...
           move rotina-tipo to wtab07-tipo-1.
           move data-a to wtab07-data-1.
           move wtab07-chave-1 to tabl-chave-1.
      *
       lab-cns-data-00-a.
