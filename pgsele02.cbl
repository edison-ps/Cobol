      ***************************************************************
      *                                                             *
      *  A B A V / C N -  I N F O R M A T I C A   :::  PGSELE02     *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Menu Principal:                                            *
      ...
      *
       01 cb-prog.
          ...
          "ABAV - Informatica".
          02 cb-programa               pic x(08) value "PGSELE02".
      ...
      *
       01 campo-menu.
          02 menu-argum                pic 9(02) comp-5 value 03.
          02 filler                    pic x(01) value low-values.
          ...
          02 menu-dados.
             ...
             03 filler                 pic 9(02) comp-5 value 06.
             03 filler                 pic x(11) value " Pesquisas".
      ...
      *
       01 campo-menu5.
          02 menu-argum5               pic 9(02) comp-5 value 04.
          02 filler                    pic x(01) value low-values.
          02 menu-tam5                 pic 9(02) comp-5 value 23.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-f5               pic 9(02) comp-5 value 02.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-p5               pic 9(02) comp-5 value 11.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-fb5              pic 9(02) comp-5 value 06.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-pb5              pic 9(02) comp-5 value 11.
          02 filler                    pic x(01) value low-values.
          02 menu-dados5.
             ...
             03 filler                 pic 9(02) comp-5 value 22.
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic x(23) value "1-Operadora Rece
      -      "ptivo".
             03 filler                 pic 9(02) comp-5 value 22.
             03 filler                 pic 9(02) comp-5 value 12.
             03 filler                 pic x(23) value "2-Operadora Expo
      -      "rtativo".
             03 filler                 pic 9(02) comp-5 value 22.
             03 filler                 pic 9(02) comp-5 value 13.
             03 filler                 pic x(23) value "3-Agencia de Via
      -      "gens".
             03 filler                 pic 9(02) comp-5 value 22.
             03 filler                 pic 9(02) comp-5 value 14.
             03 filler                 pic x(23) value "4-Turismo Rodovi
      -      "ario".
          02 filler                    pic x(01) value low-values.
      *
       01 campo-menu7.
          ...
          02 filler                    pic x(01) value low-values.
          02 menu-cor-f7               pic 9(02) comp-5 value 02.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-p7               pic 9(02) comp-5 value 11.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-fb7              pic 9(02) comp-5 value 06.
          02 filler                    pic x(01) value low-values.
          02 menu-cor-pb7              pic 9(02) comp-5 value 11.
          02 filler                    pic x(01) value low-values.
          02 menu-dados7.
      ...
      *
       01 campo-menu2.
          02 menu-argum2               pic 9(02) comp-5 value 08.
          02 filler                    pic x(01) value low-values.
          ...
          02 menu-dados2.
             ...
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic 9(02) comp-5 value 12.
             03 filler                 pic x(17) value "2-Atividades".
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic 9(02) comp-5 value 13.
             03 filler                 pic x(17) value "3-Estados".
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic 9(02) comp-5 value 14.
             03 filler                 pic x(17) value "4-Veiculos".
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic 9(02) comp-5 value 15.
      ...
      -      "s".
             ...
             03 filler                 pic x(17) value "6-Etiquetas".
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic 9(02) comp-5 value 17.
             03 filler                 pic x(17) value "7-Nao Cadastadas
      -      " ".
             03 filler                 pic 9(02) comp-5 value 11.
             03 filler                 pic 9(02) comp-5 value 18.
             03 filler                 pic x(17) value "8-Atualizacao".
          02 filler                    pic x(01) value low-values.
      *
       01 param-menu.
      ...
      *
       01 parametro-back.
          ...
          02 comando-back              pic x(14) value "C:BACK02.EXE".
      *
       01 parametro-rest.
          02 parametro-tam-rest        pic 9(02) comp-x value 12.
          02 comando-rest              pic x(14) value "C:REST02.EXE".
      *
       copy workgen.lib.
      *
       screen section.
      ...
      *
       rot-cadastro.
           ...
           perform until opc-aux = -1
                   ...
                   evaluate true
                            when opc-aux = 1
                                 call "pgat01" using param-menu 
                                 cancel "pgat01"
                            when opc-aux = 2
                                 move 15 to rotina-col
                                 move 13 to rotina-lin
                            ...
                            when opc-aux = 4
                                 ...
                                 cancel "pgtab01"
                            when opc-aux = 5
                                 call "pgat02" using param-menu 
                                 cancel "pgat02"
                            when opc-aux = 6
                                 call "pgat03" using param-menu 
                                 cancel "pgat03"
                            when opc-aux = 7
                                 call "pgat04" using param-menu 
                                 cancel "pgat04"
                            when opc-aux = 8
                                 call "pgat05" using param-menu 
                                 cancel "pgat05"
                   end-evaluate
                   display tela-rodape
                   if opc-aux not = -1
      ...
      *
       rot-receptivo.
           ...
           perform until opc-aux = -1
                   ...
                   evaluate true
                            when opc-aux = 1
                                 call "pgpr01" using param-menu
                                 cancel "pgpr01"
                            when opc-aux = 2
                                 call "pgpr02" using param-menu
                                 cancel "pgpr02"
                            when opc-aux = 3
                                 call "pgpr03" using param-menu
                                 cancel "pgpr03"
                   end-evaluate
                   display tela-rodape
                   if opc-aux not = -1
      ...
      *
       rot-back.
           ...
           call "C_Gotoxy" using by value box-col
                                 by value box-lin.
           move "C:BACK02.EXE" to comando-back.
      ...
      *
       rot-rest.
           ...
           call "C_Gotoxy" using by value box-col
                                 by value box-lin.
           move "C:REST02.EXE" to comando-rest.
