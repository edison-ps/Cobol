      ***************************************************************
      *                                                             *
      *  A B A V / S P - I N F O R M A T I C A    :::  PGFT01       *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Calculo da mensalidade ABAV :                              *
      *                                                             *
      *  Data da ultima alteracao:    30/12/93     v1.00            *
      *                               02/03/94     v1.01            *
      *                                                             *
      ***************************************************************
      * 
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGFT01".
      ...
      *
       acc-valor-c.
           accept valor-aux at 1223 with auto update prompt
                  foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
       acc-valor-i.
           accept valor-aux at 1323 with auto update prompt
                  foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
      ...
      *
       dsp-razao.
           display codigo at 1906 with foreground-color 15 
                   background-color 01.
          display razao at 1913 with foreground-color 15 
                   background-color 01.
      *
