      ***************************************************************
      *                                                             *
      *  E P S - S O F T                          :::  PGTAB04      *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Manutencao de Tabela de cias. aereas :                     *
      *                                                             *
      *  Data da ultima alteracao:    05/08/95     v1.00            *
      *                                                             *
      ***************************************************************
      * 
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGTAB04".
      ...
      *
       rot-move-tabl.
           move rotina-tipo to wtab05-tipo wtab05-tipo-1.
           move sigla to wtab05-sigla rotina-sigla.
           move descricao-aux to wtab05-descricao-1.
           move descricao to wtab05-descricao.
           move param-usr to wtab05-usr.
           move param-data to wtab05-data.
           move reg-wtab05 to reg-tabl.
           
      *
       rot-move-campos.
           move reg-tabl to reg-wtab05
           move wtab05-sigla to sigla rotina-sigla.
           move wtab05-descricao to descricao.
           move wtab05-usr to cab-usuario.
           move wtab05-data to dias-corr.
      ...
      *
       lab-inc-01.
           ...
           perform dsp-sigla.
           move rotina-tipo to wtab05-tipo.
           move sigla to wtab05-sigla.
           move spaces to wtab05-resto.
           move wtab05-chave to tabl-chave.
           perform rot-le-tabl.
           if erro = 0
              move " Cia ja cadastrado - Tecle <Enter>" to mens-erro
      ...
      *
       lab-cns-sigla-00.
           ...
           move low-values to wtab05-chave.
           move rotina-tipo to wtab05-tipo
           move txt to sigla wtab05-sigla.
           move spaces to wtab05-resto.
           move wtab05-chave to tabl-chave.
      *
       lab-cns-sigla-00-a.
      ...
      *
       lab-cns-sigla-01.
           ...
           move reg-tabl to reg-wtab05.
           if erro not = 0 or wtab05-sigla = sigla 
              perform lmp-sigla thru lmp-descricao
              start arqtabl key is not less tabl-chave
      ...
      *
       lab-cns-descricao-00.
           ...
           move rotina-tipo to wtab05-tipo-1.
           move txt to wtab05-descricao-1.
           move wtab05-chave-1 to tabl-chave-1.
      *
