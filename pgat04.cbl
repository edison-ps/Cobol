      ***************************************************************
      *                                                             *
      *  A B A V / C N - I N F O R M A T I C A    :::  PGAT04       *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGAT04".
      ...
      *
       rot-move.
           ...
           evaluate true
                    when sequencia = 1
                         move empresa-a to cab-razao-1
                         move "A/C" to cab-ac-1
                         move diretor-a to cab-titular-1
                         move endereco to cab-endereco-1
                         move cep to cab-cep-1
                         move cidade to cab-cidade-1
                         move uf to cab-uf-1
                         display "**     " at 1833
                    when sequencia = 2
                         move empresa-a to cab-razao-2
                         move "A/C" to cab-ac-2
                         move diretor-a to cab-titular-2
                         move endereco to cab-endereco-2
                         move cep to cab-cep-2
                         move cidade to cab-cidade-2
                         move uf to cab-uf-2
                         display "****   " at 1833
                    when sequencia = 3
                         move empresa-a to cab-razao-3
                         move "A/C" to cab-ac-3
                         move diretor-a to cab-titular-3
                         move endereco to cab-endereco-3
                         move cep to cab-cep-3
                         move cidade to cab-cidade-3
                         move uf to cab-uf-3
                         display "******" at 1833
           end-evaluate.
      *
