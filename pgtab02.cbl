      ***************************************************************
      *                                                             *
      *  E P S - S O F T                          :::  PGTAB02      *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Manutencao de Tabelas Estados:                             *
      *                                                             *
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGTAB02".
          02 cb-versao                 pic x(06) value "v1.02 ".
      *
       01 campos.
          02 sigla                     pic x(02) value spaces.
          02 descricao                 pic x(20) value spaces.
          02 capital                   pic x(20) value spaces.
      ...
      *
       rot-move-tabl.
           move rotina-tipo to wtab03-tipo wtab03-tipo-1.
           move sigla to wtab03-sigla rotina-sigla.
           move descricao-aux to wtab03-descricao-1.
           move descricao to wtab03-descricao.
           move capital to wtab03-capital.
           move ddd to wtab03-ddd.
           move param-usr to wtab03-usr.
           move param-data to wtab03-data.
           move reg-wtab03 to reg-tabl.
           
      *
       rot-move-campos.
           move reg-tabl to reg-wtab03
           move wtab03-sigla to sigla rotina-sigla.
           move wtab03-descricao to descricao.
           move wtab03-capital to capital.
           move wtab03-ddd to ddd.
           move wtab03-usr to cab-usuario.
           move wtab03-data to dias-corr.
      ...
      *
       rot-display.
           ...
           perform dsp-sigla thru dsp-ddd.
      ...
      *
       display-tela-01.
           ...
           display "Capital...:" at line linha column coluna with
                                    foreground-color 06
                                    background-color 01 highlight.
           add rotina-lin to 06 giving linha.
           display "D.D.D.....:" at line linha column coluna with
                                    foreground-color 06
                                    background-color 01 highlight.
      *
       display-tela-02.
      ...
      *
       acc-capital.
           ...
           add rotina-col to 14 giving coluna.
           accept capital at line linha column coluna with auto update 
                  prompt foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
       acc-ddd.
           ...
           add rotina-col to 14 giving coluna.
           accept ddd at line linha column coluna with auto update 
                  prompt foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
      ...
      *
       dsp-ddd.
           add rotina-lin to 6 giving linha.
           add rotina-col to 14 giving coluna.
           display ddd at line linha column coluna with
                   foreground-color 15 background-color 01.
      *
      ...
      *
       ...
       lab-inc-01.
           ...
           perform dsp-sigla.
           move rotina-tipo to wtab03-tipo.
           move sigla to wtab03-sigla.
           move spaces to wtab03-resto.
           move wtab03-chave to tabl-chave.
           perform rot-le-tabl.
           if erro = 0
              move " Estado ja cadastrado - Tecle <Enter>" to mens-erro
       ...
       lab-inc-05.
           ...
           if resposta = "N"
              perform lmp-sigla thru lmp-ddd
              perform display-tela-02
              go to lab-inc-01
           else
              if resposta not = "S"
      ...
      *
       lab-cns-sigla-00.
           ...
           move low-values to wtab03-chave.
           move rotina-tipo to wtab03-tipo
           move txt to sigla wtab03-sigla.
           move spaces to wtab03-resto.
           move wtab03-chave to tabl-chave.
      *
       lab-cns-sigla-00-a.
      ...
      *
       lab-cns-sigla-01.
           ...
           move reg-tabl to reg-wtab03.
           if erro not = 0 or wtab03-sigla = sigla 
              perform lmp-sigla thru lmp-ddd
              start arqtabl key is not less tabl-chave
      ...
      *
       lab-cns-descricao-00.
           ...
           move rotina-tipo to wtab03-tipo-1.
           move txt to wtab03-descricao-1.
           move wtab03-chave-1 to tabl-chave-1.
      *
