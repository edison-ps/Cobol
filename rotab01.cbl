      ***************************************************************
      *                                                             *
      *  A B A V / S P - I N F O R M A T I C A    :::  ROTAB01      *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Consulta do arquivo de cadastro :                          * 
      *                                                             *
      *  Data da ultima alteracao:    25/05/94     v1.00            *
      *                                                             *
      ***************************************************************
      * 
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "ROTAB01".
      ...
      *
       display-tela-01.
           ...
           display "Condicao......:" at line linha column coluna with
                   highlight foreground-color 06 background-color 01.
      ...
      *
       acc-condicao.
           ...
           add rotina-col to 19 giving coluna.
           accept condicao at line linha column coluna with auto update 
                  prompt foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
      ...
      *
       lab-cns-nome-fantasia-00.
           ...
           move txt to ab01-nome-fantasia in ab01-chave-1.
      *
      ...
      *
       lab-cns-nome-fantasia-01.
           ...
           if erro not = 0 or ab01-codigo = codigo
           ...
           if rotina-condicao not = spaces
              if ab01-condicao not = rotina-condicao
                 go to lab-cns-nome-fantasia-01
              end-if
           end-if.
      ...
      *
       lab-cns-razao-social-00.
           ...
           move txt to ab01-razao-social in ab01-chave-2.
      *
