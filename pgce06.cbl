      ***************************************************************
      *                                                             *
      *  E P S - S O F T                          :::  PGCE06       *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Relacao/Consulta de Produtos :                             *
      *                                                             *
      *  Data da ultima alteracao:    17/04/94     v1.00            *
      *                                                             *
      ***************************************************************
      * 
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGCE06".
      ...
      *
       01 tela-erro-cad.
          02 line 19 column 05 beep reverse-video pic x(69) from 
             mensagem.
      *
       01 tela-limpa-cad.
      ...
      *
       accept-resposta-cad.
           ...
           accept resposta at 1840 with auto foreground-color 04
                                             background-color 04.
      ...
      *
       acc-grupo.
           accept sele-grupo at 1522 with auto update prompt
                  foreground-color 15 background-color 04.
           accept escape-key from escape.
           exit.
      *
       acc-produto.
           accept sele-produto at 1622 with auto update prompt
                  foreground-color 15 background-color 04.
           accept escape-key from escape.
           exit.
      *
      ...
      *
       dsp-grupo.
           display sele-grupo-disp at 1522 with foreground-color 15 
                   background-color 04.
           display sele-dgrupo at 1528 with foreground-color 15 
                   background-color 04.
      *
       dsp-produto.
           display sele-produto-disp at 1622 with foreground-color 15 
                   background-color 04.
           display sele-dproduto at 1628 with foreground-color 15 
                   background-color 04.
      *
       dsp-device.
