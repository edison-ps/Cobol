      ***************************************************************
      *                                                             *
      *  A B A V / S P - I N F O R M A T I C A    :::  PGRC01       *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Manutencao do cadastro CTAS a Receber :                    *
      *                                                             *
      *  Data da ultima alteracao:    28/12/93     v1.00            *
      *                               07/10/95     v1.01            *
      *                                                             *
      ***************************************************************
      * 
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGRC01".
      ...
      *
       rot-move-rc01.
           ...
           move condicao to rc01-condicao.
      ...
      *
       rot-move-campos.
           move rc01-codigo to codigo.
           move rc01-condicao to condicao.
           ...
           move rc01-valor to valor valor-disp valor-aux.
      ...
      *
       rot-le-rc01-1.
           move 0 to erro.
           read arqrc01 key rc01-chave-1 invalid key move 1 to erro.
           if rc01-status = "9D"
              move 0 to erro
              call "C_Wait" using by value campo-wait
              go to rot-le-rc01-1.
      ...
      *
       rot-le-anterior.
           move 0 to erro.
           read arqrc01 previous at end move 1 to erro.
           if rc01-status = "9D"
              move 0 to erro
              call "C_Wait" using by value campo-wait
      ...
      *
       acc-doc-cob.
           accept doc-cob at 1232 with auto update prompt
                  foreground-color 15 background-color 01.
           accept escape-key from escape.
           exit.
      *
      ...
      *
       dsp-doc-cob.
           display doc-cob at 1232 with foreground-color 15 
                   background-color 01.
      *
       dsp-vencimento.
      ...
      *
       lmp-doc-cob.
           display limpa-10 at 1232 with foreground-color 15 
                   background-color 01.
      *
       lmp-vencimento.
      ...
      *
       lab-inc-02.
           ...
           perform lmp-documento thru lmp-doc-cob.
      ...
      *
       lab-cns-codigo-00.
           ...
           perform rot-texto.
           move txt to condicao.
           if condicao not = "A" and "F" and space
      ...
      *
       lab-cns-codigo-01.
           ...
           if erro not = 0 or rc01-documento = documento
      ...
      *
       lab-cns-codigo-02.
           start arqrc01 key is less rc01-chave-1.
      *
       lab-cns-codigo-03.
       ...
       lab-cns-codigo-05.
           ...
           evaluate true
                    ...
                    when kbd-aux = 71
                         ...
                         go to lab-cns-codigo-00-a
                    when kbd-aux = 79
                         move high-values to rc01-chave-1
      ...
      *
       lab-cns-documento-02.
           start arqrc01 key is less rc01-chave.
      *
      ...
      *
       lab-cns-vencimento-02.
           start arqrc01 key is less rc01-chave-2.
      *
       ...
       lab-cns-vencimento-05.
           ...
           evaluate true
                    ...
                    when kbd-aux = 71
                         ...
                         go to lab-cns-vencimento-00-a
                    when kbd-aux = 79
                         move high-values to rc01-chave-2
