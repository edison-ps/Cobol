      ***************************************************************
      *                                                             *
      *  E P S - S O F T                          :::  PGTAB03      *
      *                                                             * 
      *-------------------------------------------------------------*
      *                                                             *
      *  Manutencao de Tabela de Cidades:                           *
      *                                                             *
      ...
      *
       01 cb-prog.
          02 cb-programa               pic x(08) value "PGTAB03".
          02 cb-versao                 pic x(06) value "v1.00 ".
      *
       01 campos.
          02 sigla                     pic x(03) value spaces.
      ...
      *
       rot-move-tabl.
           move rotina-tipo to wtab04-tipo wtab04-tipo-1.
           move sigla to wtab04-sigla rotina-sigla.
           move descricao-aux to wtab04-descricao-1.
           move descricao to wtab04-descricao.
           move param-usr to wtab04-usr.
           move param-data to wtab04-data.
           move reg-wtab04 to reg-tabl.
           
      *
       rot-move-campos.
           move reg-tabl to reg-wtab04
           move wtab04-sigla to sigla rotina-sigla.
           move wtab04-descricao to descricao.
           move wtab04-usr to cab-usuario.
           move wtab04-data to dias-corr.
      ...
      *
       lab-inc-01.
           ...
           perform dsp-sigla.
           move rotina-tipo to wtab04-tipo.
           move sigla to wtab04-sigla.
           move spaces to wtab04-resto.
           move wtab04-chave to tabl-chave.
           perform rot-le-tabl.
           if erro = 0
              move " Cidade ja cadastrado - Tecle <Enter>" to mens-erro
      ...
      *
       lab-cns-sigla-00.
           ...
           move low-values to wtab04-chave.
           move rotina-tipo to wtab04-tipo
           move txt to sigla wtab04-sigla.
           move spaces to wtab04-resto.
           move wtab04-chave to tabl-chave.
      *
       lab-cns-sigla-00-a.
      ...
      *
       lab-cns-sigla-01.
           ...
           move reg-tabl to reg-wtab04.
           if erro not = 0 or wtab04-sigla = sigla 
              perform lmp-sigla thru lmp-descricao
              start arqtabl key is not less tabl-chave
      ...
      *
       lab-cns-descricao-00.
           ...
           move rotina-tipo to wtab04-tipo-1.
           move txt to wtab04-descricao-1.
           move wtab04-chave-1 to tabl-chave-1.
      *
